...
{
       0,    36,    36,    40,    41,    44,    48,    54,    55,    59,
      65,    72,    81,    82,    86,    94,   104,   108,   113,   117,
     124,   131,   136
};
#endif
...
static const char *const yytname[] =
{
  ...
  "ERR", "$accept", "goal", "commands", "command", "simple_command",
...
{
       6,    -3,    -6,     9,    11,     1,    -6,    -6,    13,    -6,
      -6,    -6,    -6,    -6,    16,    20,    24,    25,     4,    26,
      -6,    -6,    17,    -6,    -6,     6,    27,    -6,    -6,    28,
      29,     5,    -6,    -6,    -6
};
...
{
       0,     0,    15,     0,     0,     0,     3,     5,    22,    13,
       7,     8,     1,     4,     0,     0,     0,     0,     0,    11,
      16,    17,    18,    21,     6,     0,     0,    14,    12,     0,
       0,     0,     9,    19,    20
};
...
{
      -6,    -6,    10,    -5,    -6,    -6,    -6,    -6,    -6,    -6
};

/* YYDEFGOTO[NTERM-NUM].  */
static const yytype_int8 yydefgoto[] =
{
       0,     4,     5,     6,     7,     8,    19,    28,     9,    18
};
...
{
      13,    -2,     1,    10,     2,   -10,     1,     1,     2,     2,
      24,    12,     3,    25,    26,    11,     3,     3,    14,    20,
      15,    16,    29,    21,    30,    17,    13,    22,    23,    27,
       0,    33,    34,    32,     0,    31
};
...
{
       5,     0,     1,     6,     3,     0,     1,     1,     3,     3,
       6,     0,    11,     9,    10,     6,    11,    11,     5,     3,
       7,     8,     5,     3,     7,    12,    31,     3,     3,     3,
      -1,     3,     3,     6,    -1,    25
};
...
{
       0,     1,     3,    11,    14,    15,    16,    17,    18,    21,
       6,     6,     0,    16,     5,     7,     8,    12,    22,    19,
       3,     3,     3,     3,     6,     9,    10,     3,    20,     5,
       7,    15,     6,     3,     3
};
...
#line 1180 "y.tab.c"
  ...
  case 7: /* simple_command: error NEWLINE  */
#line 54 "shell.y"
                        { yyerrok; }
#line 1186 "y.tab.c"
    break;
...
#line 1206 "y.tab.c"
  ...
  case 10: /* simple_command: command_and_args iomodifier_opt PIPE commands  */
#line 65 "shell.y"
                                                        {
		printf("   Yacc: Execute command\n");
		Command::_currentCommand.execute();
...
#line 1257 "y.tab.c"
  ...
  case 17: /* iomodifier_opt: APPEND WORD  */
#line 108 "shell.y"
                      {
...
#line 1267 "y.tab.c"
  ...
  case 18: /* iomodifier_opt: READ WORD  */
#line 113 "shell.y"
                    {
...
#line 1276 "y.tab.c"
  ...
  case 19: /* iomodifier_opt: READ WORD GREAT WORD  */
#line 117 "shell.y"
                               {
		printf("   Yacc: insert output \"%s\"\n", (yyvsp[0].string_val));
		Command::_currentCommand._outFile = (yyvsp[0].string_val);
...
#line 1287 "y.tab.c"
  ...
  case 20: /* iomodifier_opt: READ WORD APPEND WORD  */
#line 124 "shell.y"
                                {
		printf("   Yacc: insert append output \"%s\"\n", (yyvsp[0].string_val));
		Command::_currentCommand._outFile = (yyvsp[0].string_val);
...
#line 1299 "y.tab.c"
  ...
  case 21: /* iomodifier_opt: ERR WORD  */
#line 131 "shell.y"
                   {
